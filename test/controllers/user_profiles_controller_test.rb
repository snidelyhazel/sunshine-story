...
class UserProfilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_profile" do
    assert_difference('UserProfile.count') do
      post user_profiles_url, params: { user_profile: { last_update: @user_profile.last_update, sun_penny: @user_profile.sun_penny, user_name: @user_profile.user_name } }
    end
  ...
  test "should update user_profile" do
    patch user_profile_url(@user_profile), params: { user_profile: { last_update: @user_profile.last_update, sun_penny: @user_profile.sun_penny, user_name: @user_profile.user_name } }
